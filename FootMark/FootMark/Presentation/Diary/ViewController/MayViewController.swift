...
class MayViewController: BaseViewController {
   
    var diaryView = MayView()
...
extension MayViewController: ElegantEmojiPickerDelegate {
...
extension MayViewController: UITextViewDelegate {
