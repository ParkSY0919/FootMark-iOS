...
class BFDiaryViewController: BaseViewController {
   
    var diaryView = BFDiaryView()
...
extension BFDiaryViewController: ElegantEmojiPickerDelegate {
...
extension BFDiaryViewController: UITextViewDelegate {
